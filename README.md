...
| Domain | Focus |
|--------|-------|
| **Full-Stack Web** | React, Node.js, Socket.IO, real-time systems |
| **Data & Analytics** | Python, Excel, Power BI, data visualization |
...
`React` · `Node.js` · `Express` · `Socket.IO` · `Framer Motion` · `Zustand` · `Jetpack Compose`
...
`Git` · `GitHub` · `VS Code` · `Linux` · `Vite` · `Vercel` · `Render`

**Cloud & Data**

`AWS` · `Excel` · `Power BI` · `Data Visualization`
...
<p align="center">
  ...
  &nbsp;&nbsp;&nbsp;
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=SNikhil2645&theme=tokyonight&hide_border=true&bg_color=0d1117" height="170" />
</p>
